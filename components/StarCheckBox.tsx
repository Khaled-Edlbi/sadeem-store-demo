...
function StarCheckBox({ index, primaryImage, handleCheckboxChange }: StarCheckBoxProps) {
  ...
  return (
    <label className="relative block cursor-pointer select-none">
      ...
      <svg 
        ...
        className={`relative top-0 left-0 w-[35px] h-[35px] duration-100 
        fill-[#666] ${index === primaryImage ? 'fill-[#ffeb49]' : ''} 
        hover:scale-105 mb-[3px]`}
      >
        <g><g>
